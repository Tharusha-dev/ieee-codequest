  ...
  return (
    <section id={id} className="w-full max-w-4xl text-center">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div
          ref={ref1}
          className={`bg-gray-900 p-6 rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-[0_0_20px_5px_rgba(0,255,0,0.2)] ${isIntersecting1 ? 'fade-in-up' : 'opacity-0'}`}
        >
        ...
        <div
          ref={ref3}
          className={`bg-gray-900 p-6 rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-[0_0_20px_5px_rgba(0,255,0,0.2)] ${isIntersecting3 ? 'fade-in-up' : 'opacity-0'}`}
